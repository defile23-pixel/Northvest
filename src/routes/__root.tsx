...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // Per-page routes (index.tsx, dashboard.tsx, etc.) override title/og tags where
      // it matters; these are the fallback for any page that doesn't, so they need to
      // actually describe Northvest rather than the Lovable scaffold they replace.
      ...
      { name: "theme-color", content: "#2F3190" },
